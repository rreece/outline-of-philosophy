...
-   Riemens, R. (2024). Fixing the earth: Whole-systems thinking in Silicon Valley's environmental ideology. [^Riemens2024]
...
[^Riemens2024]: @Riemens_2024_Fixing_the_earth_Whole_systems_thinking\.
...
-   Leslie, J.A. (1996). *The End of the World: The Science and Ethics of Human Extinction*. [^Leslie1996]
-   Bostrom, N. (2002). [Existential risks analyzing human extinction scenarios and related hazards](https://nickbostrom.com/papers/existential-risks/existential-risks.pdf). [^Bostrom2002a]
...
-   Torres, E.P. (2026). [Nick Bostrom took many of his "best" ideas from other people](https://www.realtimetechpocalypse.com/p/nick-bostrom-took-many-of-his-best).

[^Baum2019]: @Baum_2019_Long_term_trajectories_of_human_civilization\.
[^Bostrom2002a]: @Bostrom_2002_Existential_risks_analyzing_human_extinction\.
...
[^Leslie1996]: @Leslie_1996_The_End_of_the_World_The_Science_and_Ethics\.
...
-   Bostrom, N. (2002). *Anthropic Bias: Observation selection effects in science and philosophy*. [^Bostrom2002b]
...
-   Schmidhuber, J. (1997). [A computer scientist's view of life, the universe, and everything](https://arxiv.org/abs/quant-ph/9904050). [^Schmidhuber1997]
...
[^Schmidhuber1997]: @Schmidhuber_1997_A_computer_scientists_view_of_life_the_universe\.
...
-   Rubin, R. & Cowen, T. (2026). Video: [Tetragrammaton: Why is Tyler Cowen optimistic about AI?](https://www.youtube.com/watch?v=HGkoxpyo-cs).
...
-   Bostrom, N. & Yudkowsky, E. (2014). [The ethics of artificial intelligence](https://intelligence.org/files/EthicsofAI.pdf). [^BostromYudkowsky2014]
...
-   Amodei, D. (2026). [The adolescence of technology: Confronting and overcoming the risks of powerful AI](https://darioamodei.com/essay/the-adolescence-of-technology).
-   Olah, C. (2026). [Anthropic co-founder Chris Olah's remarks on Pope Leo XIV's encyclical "Magnifica humanitas"](https://www.anthropic.com/news/chris-olah-pope-leo-encyclical).
-   Patel, D. (2026). [The rise and fall of agent civilizations: The whole OpenAI/HuggingFace story in plain English](https://www.dwarkesh.com/p/openai-huggingface). 2026/08/29.
-   Amodei, D. (2026). [We must pace the frontier](https://darioamodei.com/post/we-must-pace-the-frontier). 2026/09/12.
...
[^BostromYudkowsky2014]: @Bostrom_2014_The_ethics_of_artificial_intelligence\.
...
-   Moravec, H. (1998). [When will computer hardware match the human brain?](https://jetpress.org/volume1/moravec.htm). [^Moravec1998]
-   Ray Kurzweil (b. 1948)
...
-   Modis, T. (2006). The singularity myth. [^Modis2006]
-   Related terms:
    -   Extropianism
    -   (New) rationalism
    -   Effective altruism
    ...
    -   Transhumanism
    -   Singularitarianism
    -   [TESCREAL](https://en.wikipedia.org/wiki/TESCREAL) - Timnit Gebru and &Eacute;mile P. Torres
    -   Torres, E.P. (2026). [Skeptical of the TESCREAL acronym? Read this](https://www.realtimetechpocalypse.com/p/skeptical-of-the-tescreal-acronym).
-   Silicon Valley thought
    -   Barbrook, R. & Cameron, A. (1996). The Californian ideology. [^Barbrook1996]
    -   Uluorta, H.M. & Quill, L. (2022). The Californian ideology revisited. [^Uluorta2022]
    -   Andreessen, M. (2023). [The techno-optimist manifesto](https://a16z.com/the-techno-optimist-manifesto/).
    -   [LessWrong](https://www.lesswrong.com/)
-   Organizations
    -   [Machine Intelligence Research Institute](https://en.wikipedia.org/wiki/Machine_Intelligence_Research_Institute), Berkeley, CA (est. 2005)
        -   Eliezer Yudkowsky, Founder
        -   Bensinger, R. (2016). [AI and Effective Altruism](https://intelligence.org/2015/08/28/ai-and-effective-altruism/).
    -   [Future of Life Institute](https://futureoflife.org) (est. 2014)
        -   Max Tegmark, President
    -   [Future of Humanity Institute](https://en.wikipedia.org/wiki/Future_of_Humanity_Institute), Oxford University (2005-2024)
        -   Nick Bostrom, Director
    -   [Coefficient Giving (formerly Open Philanthropy)[(https://en.wikipedia.org/wiki/Coefficient_Giving)

See also:

-   [Effective altruism](ethics.html#effective-altruism) in the [Outline on Ethics](ethics.html)

[^Barbrook1996]: @Barbrook_1996_The_Californian_ideology\.
[^Bostrom2005]: @Bostrom_2005_The_fable_of_the_dragon_tyrant\.
[^Modis2006]: @Modis_2006_The_singularity_myth\.
[^Moravec1998]: @Moravec_1998_When_will_computer_hardware_match_the_human_brain\.
[^Uluorta2022]: @Uluorta_2022_The_Californian_ideology_revisited\.
