...
$$ 
\begin{align}
\mathrm{rngs} &\supset \mathrm{rings} \supset \mathrm{commutative\ rings} \supset \mathrm{integral\ domains} \supset \mathrm{integrally\ closed\ domains} \\
    &\supset \mathrm{GCD\ domains} \supset \mathrm{unique\ factorization\ domains} \supset \mathrm{principal\ ideal\ domains} \\
    &\supset \mathrm{euclidean\ domains} \supset \mathrm{fields} \supset \mathrm{algebraically\ closed\ fields}
\end{align}
$$
