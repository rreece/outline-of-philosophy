...
-   Cyclic groups of prime order, $Z_n$ 
-   Alternating groups, $\mathrm{Alt}_n$ for $n \geq 5$
-   Lie type groups:
    -   Classical/Chevalley groups: $A_n$, $B_n$, $C_n$, $D_n$
    -   Exceptional groups: $E_6$, $E_7$, $E_8$, $F_4$, $G_2$
    -   Twisted groups: ${}^{2}A_{n}$, ${}^{2}D_{n}$, ${}^{3}D_{4}$, ${}^{2}E_{6}$,
        plus the Suzuki and Ree groups ${}^{2}B_{2}$, ${}^{2}F_{4}$, ${}^{2}G_{2}$
-   Tits group: ${}^{2}F_{4}(2)^\prime$
-   26 Sporadic groups
